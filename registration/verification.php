...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if($otp_num==$otp)
		{
			...
			$update = "UPDATE tbl_login SET status='1' WHERE login_id='$id' AND type='2'";
		...
		elseif($otp_num==$otp)
		{
			...
			$update2 = "UPDATE tbl_login SET status='1' WHERE login_id='$id' AND type='3'";
			$result3 = mysqli_query($con,$update2);
		...
		elseif($otp_num==$otp)
		{
			...
			$update3 = "UPDATE tbl_login SET status='1' WHERE login_id='$id' AND type='1'";
			$result4 = mysqli_query($con,$update3);
