      ...
      <!-- Small boxes (Stat box) -->
	   ...
	   <div class="box box-warning">
			...
			?>	
              ...
              <form role="form" method="POST" action="insert_lawyer.php" enctype="multipart/form-data" >
                <!-- text input -->
...
number starting with 7 or 8 or 9' required />
				...
				<div class="form-group">
                  ...
                  <input type="text" name="enrol" class="form-control" placeholder="Enter Enrollment ..." required />
                </div>
