...
<body>
	<div class="container main-section">
		<div class="row">
				...
				<div class="input-group searchbox">
					<div class="input-group-btn">
						...
						<?php
								...
								if(isset($_POST['back'])){
									$update_msg = mysqli_query($con, "UPDATE lawyer SET log_in='Offline' WHERE law_id='$id2'");
			...
			<div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
				<div class="row">
					...
					<?php 
					$update_seen = mysqli_query($con, "UPDATE lawyer SET log_in='Online' WHERE law_id='$id2'");
						$log = $_SESSION['log'];
		...
		$law_name=mysqli_query($con,"SELECT name FROM tbl_register WHERE l_id='$id'");
		$law_name2=mysqli_fetch_array($law_name);
		$law_name3=$law_name2['name'];
		...
		$id2 = $value2['law_id'];
						...
						$get_user = "select * from tbl_register where l_id ='$id'"; 
					...
					$user_profile_image="";
						...
						$get_user = "select * from tbl_client where name='$get_username'";
