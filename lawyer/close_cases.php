    ...
    <section class="content">
      ...
      <div class="row">
		...
		$log=$_SESSION['log'];
					...
					$xyz=$value['l_id'];
			$qry1="SELECT 
    tbl_client.name,tbl_case.title,tbl_case.casedesc,tbl_case.ca_id
FROM 
    tbl_client
INNER JOIN 
    tbl_case
...
WHERE 
    tbl_case.l_id='$xyz' && status='0'";
		...
		?>
			...
			<td>
                  <a href="report1.php?id=<?php echo $val; ?>" onclick="return confirm('Move to Open Cases');" class="btn btn-success btn-xs">Move</a>
				  <a href="editclosecases.php?id=<?php echo $val; ?>" class="btn btn-success btn-xs">Edit</a>
