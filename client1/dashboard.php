                  ...
                  <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-left">Jiya Shah</span>
                        <span class="direct-chat-timestamp pull-right">23 Jan 2:00 pm</span>
                      </div>
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="jiya.jpg" alt="message user image">
                      <!-- /.direct-chat-img -->
                    ...
                    <div class="direct-chat-msg right">
                      <div class="direct-chat-info clearfix">
                        <span class="direct-chat-name pull-right">Zinal Thakkar</span>
                        <span class="direct-chat-timestamp pull-left">23 Jan 2:05 pm</span>
                      </div>
                      <!-- /.direct-chat-info -->
                      <img class="direct-chat-img" src="favpic.jpg" alt="message user image">
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                        Yeah hello Jiya
                      </div>
                    ...
                    <div class="direct-chat-msg">
                      ...
                      <!-- /.direct-chat-img -->
                      <div class="direct-chat-text">
                        What's the date of next Hearing?
                      </div>
                      <!-- /.direct-chat-text -->
                    </div>
                    <!-- /.direct-chat-msg -->
