...
if(isset($_GET['id']))
	...
	else
	{
		    ...
		    $query="SELECT tbl_client.l_id,tbl_client.address,tbl_client.img,tbl_client.name,tbl_login.phone,tbl_login.email FROM tbl_client,tbl_login WHERE  tbl_client.l_id=tbl_login.l_id AND tbl_client.c_id='$clientid'";
