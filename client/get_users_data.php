<?php
	...
	if(!isset($_SESSION['log']))
	{
		...
		$sql2 = "SELECT c_id,law_id,log_in FROM tbl_client WHERE l_id='$id'";
		...
		$sql3 = "SELECT l_id,log_in FROM lawyer WHERE law_id='$id3'";
	...
	$user = "select tbl_login.l_id,tbl_login.email,tbl_register.name,tbl_register.gender,tbl_register.img from tbl_login,tbl_register where tbl_login.l_id = tbl_register.l_id AND tbl_login.l_id='$id3'";
			
	$run_user = mysqli_query($con,$user);
			
	while ($row_user=mysqli_fetch_array($run_user)){
			
	$user_id = $row_user['l_id'];
